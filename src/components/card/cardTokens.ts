...
export const RARITY_TOKENS: Record<Rarity, RarityTokens> = {
  ...
  epic: {
    bezel: {
      id: 'bezel-epic',
      stops: [
        { offset: '0%', color: '#3a1c08' },
        { offset: '30%', color: '#8a4a14' },
        { offset: '50%', color: '#e8a040' },
        { offset: '55%', color: '#fff0b8' },
        { offset: '65%', color: '#c87826' },
        { offset: '100%', color: '#2a1404' },
      ],
    },
    bevel: 'rgba(255,210,140,0.55)',
    glow: 'rgba(240,140,40,0.55)',
    auraIntensity: 0.6,
    accent: '#ffc878',
    label: 'EPIC',
    sigil: 'hexagon',
  ...
  legendary: {
    bezel: {
      id: 'bezel-legendary',
      stops: [
        { offset: '0%', color: '#0a0612' },
        { offset: '20%', color: '#1a0e2e' },
        { offset: '40%', color: '#2d1252' },
        { offset: '50%', color: '#5a2a88' },
        { offset: '60%', color: '#2d1252' },
        { offset: '80%', color: '#0e0a1c' },
        { offset: '100%', color: '#050308' },
      ],
    },
    bevel: 'rgba(220,170,255,0.6)',
    glow: 'rgba(180,90,255,0.6)',
    auraIntensity: 1,
    accent: '#f0d878',
    label: 'LEGENDARY',
    sigil: 'eye',
